...
1. Для начала необходимо выбрать директорию, в которую будет склонирован репозиторий и перейти в эту директорию. Оттуда нужно склонировать данный репозиторий, ввести следующую команду в терминале:
